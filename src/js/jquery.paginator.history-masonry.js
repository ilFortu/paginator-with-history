...
(function ($) {
  ...
  $.fn.paginatorHistory = function (options) {
    ...
    var defaults = {
      ...
      ajaxDoneAfterPrevLoadedOnStart: function () {
      },
          ...
          if (content != null && content != "") {
            ...
            if (typeof html !== 'undefined' && html != "") {
              ...
              if (isNext) {
                ...
                if (settings.preventAutoScroll == false) {
                  ...
                  if (prevLoadOnStart) {
                    ...
                    var heightPrevPage = $(newPageBlock).height();
                ...
                if (prevLoadOnStart) {
                  ...
                  // Here's the callback:
                  settings.ajaxDoneAfterPrevLoadedOnStart.call(this);
                }
